...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startButton.clicked.connect(Main.startCapture)
        ...
        self.l_h = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.l_s = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.l_v = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.u_h = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.u_s = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.u_v = QtWidgets.QSlider(self.verticalLayoutWidget_2)
