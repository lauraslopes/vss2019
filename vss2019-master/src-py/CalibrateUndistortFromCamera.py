...
# Loop over the captured images. Do this until you get 30 images.
i = 1
while i <= 30:
  ...
  if ret==True:
    ...
    retorno, corners = cv2.findChessboardCorners(gray, (rows, cols), None)
...
#Release Camera if job is finished
cap.release()
# out.release()
...
np.savez('/home/gabriel/Downloads/VSSS/vss2019-master/data/calib.npz', mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
